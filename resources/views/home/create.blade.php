            ...
            <div class="col-md-4 col-md-offset-2">
                <form action=" {{ route('employee.store')}}" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="gender" id="exampleFormControlInput1" placeholder="">
                        @error('gender')
                        <span style="color: red">{{$message}}</span>     
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="salary" id="exampleFormControlInput1" placeholder="">
                        @error('salary')
                        <span style="color: red">{{$message}}</span>     
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="desig" id="exampleFormControlInput1" placeholder="">
                        @error('desig')
                        <span style="color: red">{{$message}}</span>     
                        @enderror
                    </div>
